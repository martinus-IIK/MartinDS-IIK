...
<script type="text/javascript" src="script/word-7-datatext.js"></script>
<script type="text/javascript" src="script/word-7-dataimage.js"></script>
<script type="text/javascript" src="script/word-7-databutton.js"></script>
<script type="text/javascript" src="script/word-7-explanation.js"></script>
                    ...
                    <td class="learn-progress-column-left">
                        <label>Materi yang aktif :
                            <select id="learn-select-material" onChange='tutorialControl(this.value,0)';>
                              ...
                              <option value="1">2. Pengolahan Mail Merge</option>
                            </select>
                        </label>
                    </td>
