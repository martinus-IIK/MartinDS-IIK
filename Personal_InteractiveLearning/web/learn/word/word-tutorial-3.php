...
<script type="text/javascript" src="script/word-3-datatext.js"></script>
<script type="text/javascript" src="script/word-3-dataimage.js"></script>
<script type="text/javascript" src="script/word-3-databutton.js"></script>
<script type="text/javascript" src="script/word-3-explanation.js"></script>
                    ...
                    <td class="learn-progress-column-left">
                        <label>Materi yang aktif :
                            <select id="learn-select-material" onChange='tutorialControl(this.value,0)';>
                              <option value="0" selected="SELECTED">1. Memberi Warna Text </option>
                              <option value="1">2. Memberi Animasi pada text</option>
                              <option value="2">3. Perubahan jenis huruf / Font</option>
                              <option value="3">4. Perubahan bentuk huruf / Case</option>
                              <option value="4">5. Memasukkan AutoText</option>
                              <option value="5">6. Memeriksa kesalahan Ejaan</option>
                              <option value="6">7. Membuat Text bentuk Koran</option>
                              <option value="7">8. Memindah Text antar Kolom</option>
                              <option value="8">9. Pemberian Nomor Halaman</option>
                              <option value="9">10. Membuat Header dan Footer</option>
                              <option value="10">11. Bekerja dengan Footnote</option>
                            </select>
                        </label>
                    </td>
