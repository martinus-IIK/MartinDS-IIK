...
<script type="text/javascript" src="script/word-5-datatext.js"></script>
<script type="text/javascript" src="script/word-5-dataimage.js"></script>
<script type="text/javascript" src="script/word-5-databutton.js"></script>
<script type="text/javascript" src="script/word-5-explanation.js"></script>
                    ...
                    <td class="learn-progress-column-left">
                        <label>Materi yang aktif :
                            <select id="learn-select-material" onChange='tutorialControl(this.value,0)';>
                              <option value="0" selected="SELECTED">1. Menyisipkan dan Modifikasi Gambar</option>
                              <option value="1">2. Bekerja dengan Diagram</option>
                              <option value="2">3. Pengaturan Text dan Gambar</option>
                              <option value="3">4. Bekerja dengan Word Art</option>
                              <option value="4">5. Menggambar dan Modifikasi bentuk</option>
                            </select>
                        </label>
                    </td>
