...
<script type="text/javascript" src="script/word-6-datatext.js"></script>
<script type="text/javascript" src="script/word-6-dataimage.js"></script>
<script type="text/javascript" src="script/word-6-databutton.js"></script>
<script type="text/javascript" src="script/word-6-tutwrapper.js"></script>
<script type="text/javascript" src="script/word-6-explanation.js"></script>
                    ...
                    <td class="learn-progress-column-left">
                        <label>Materi yang aktif :
                            <select id="learn-select-material" onChange='tutorialControl(this.value,0)';>
                              <option value="0" selected="SELECTED">1. Membuat Tabel</option>
                              <option value="1">2. Menyisipkan Baris dan Kolom</option>
                              <option value="2">3. Menghapus Tabel, Baris, Kolom dan Sel</option>
                              <option value="3">4. Mengopi Tabel dan Mengopi Kolom</option>
                              <option value="4">5. Menggabungkan Sel dan Membagi Sel</option>
                              <option value="5">6. Memilih Garis dan Warna Tabel</option>
                            </select>
                        </label>
                    </td>
