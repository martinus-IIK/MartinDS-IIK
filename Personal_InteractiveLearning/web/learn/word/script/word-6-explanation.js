...
function tutorialControl(tmpWord_newPoint,tmpWord_newSubpoint){
	...
	//Special Properties
	var DOM_divTutorial=document.createElement("div");
	DOM_divTutorial.style.background=(wTutorialWrapper[tmpWord_newPoint][tmpWord_newSubpoint][0] != null) ? wTutorialWrapper[tmpWord_newPoint][tmpWord_newSubpoint][0] : "none";
	
	DOM_divTutorial.style.cursor=(wTutorialWrapper[tmpWord_newPoint][tmpWord_newSubpoint][1] != "") ? wTutorialWrapper[tmpWord_newPoint][tmpWord_newSubpoint][1] : "auto";
	DOM_divTutorial.style.position=(wTutorialWrapper[tmpWord_newPoint][tmpWord_newSubpoint][2] != "") ? wTutorialWrapper[tmpWord_newPoint][tmpWord_newSubpoint][2] : "";
	DOM_divTutorial.style.width=(wTutorialWrapper[tmpWord_newPoint][tmpWord_newSubpoint][3] != "") ? wTutorialWrapper[tmpWord_newPoint][tmpWord_newSubpoint][3] : "";
	DOM_divTutorial.style.height=(wTutorialWrapper[tmpWord_newPoint][tmpWord_newSubpoint][4] != "") ? wTutorialWrapper[tmpWord_newPoint][tmpWord_newSubpoint][4] : "";
	DOM_divTutorial.style.top=(wTutorialWrapper[tmpWord_newPoint][tmpWord_newSubpoint][5] != "") ? wTutorialWrapper[tmpWord_newPoint][tmpWord_newSubpoint][5] : "";
	DOM_divTutorial.style.right=(wTutorialWrapper[tmpWord_newPoint][tmpWord_newSubpoint][6] != "") ? wTutorialWrapper[tmpWord_newPoint][tmpWord_newSubpoint][6] : "";
	DOM_divTutorial.style.bottom=(wTutorialWrapper[tmpWord_newPoint][tmpWord_newSubpoint][7] != "") ? wTutorialWrapper[tmpWord_newPoint][tmpWord_newSubpoint][7] : "";
	DOM_divTutorial.style.left=(wTutorialWrapper[tmpWord_newPoint][tmpWord_newSubpoint][8] != "") ? wTutorialWrapper[tmpWord_newPoint][tmpWord_newSubpoint][8] : "";
	DOM_divTutorial.style.zIndex=(wTutorialWrapper[tmpWord_newPoint][tmpWord_newSubpoint][9] != "") ? wTutorialWrapper[tmpWord_newPoint][tmpWord_newSubpoint][9] : "";
	DOM_divTutorial.setAttribute('lifeDuration',wTutorialWrapper[tmpWord_newPoint][tmpWord_newSubpoint][10]);
	if (DOM_divTutorial.style.background != 'none') document.getElementById('main-tutorialimage-box').appendChild(DOM_divTutorial);
