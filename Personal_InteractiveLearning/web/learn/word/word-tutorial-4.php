...
<script type="text/javascript" src="script/word-4-datatext.js"></script>
<script type="text/javascript" src="script/word-4-dataimage.js"></script>
<script type="text/javascript" src="script/word-4-databutton.js"></script>
<script type="text/javascript" src="script/word-4-explanation.js"></script>
                    ...
                    <td class="learn-progress-column-left">
                        <label>Materi yang aktif :
                            <select id="learn-select-material" onChange='tutorialControl(this.value,0)';>
                              <option value="0" selected="SELECTED">1. Membuat Bentuk Koran</option>
                            </select>
                        </label>
                    </td>
